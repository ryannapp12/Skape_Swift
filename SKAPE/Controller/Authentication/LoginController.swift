...
class LoginController: UIViewController {
    ...
    private let titleLabel: UILabel = {
        let label = UILabel()
        label.text = ""
        label.font = UIFont(name: "Avenir-Black", size: 80)
        label.textColor = .black
        label.addImageWith(name: "rsz_skape_website_logo (1)", behindText: true)
    ...
    let dontHaveAccountButton: UIButton = {
        ...
        attributedTitle.append(NSAttributedString(string: "Sign Up", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 16), NSAttributedString.Key.foregroundColor: UIColor.mainGreenTint]))
